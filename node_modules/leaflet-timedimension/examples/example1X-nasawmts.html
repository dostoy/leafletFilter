<html>
    <head>
        ...
        <link rel="stylesheet" href="js/vendors/leaflet-0.7.3/leaflet.css" />
    ...
    <body>
        <div class="container">
            <div id="header">
                ...
                <h2>Global Imagery Browse Services (GIBS) from NASA</h2>
            </div>
        ...
        <script type="text/javascript" src="../src/leaflet.timedimension.layer.wmts.js"></script>
        ...
        <script type="text/javascript" src="js/example1x-nasawmts.js"></script>
        <script src="http://cdnjs.cloudflare.com/ajax/libs/highlight.js/8.4/highlight.min.js"></script>
        <script type="text/javascript">
            $(document).ready(function() {
                $.ajax('js/example1x-nasawmts.js', {dataType: 'script'})
