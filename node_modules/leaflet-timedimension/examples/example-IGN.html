    ...
    <body>
        <div class="container">
            <div id="header">
                ...
                <h2>Land use from <a href="http://www.ign.es/ign/layoutIn/actividadesIDEservicios.do">IGN</a></h2>
            </div>
        ...
        <script type="text/javascript" src="js/example-IGN.js"></script>
        <script src="http://cdnjs.cloudflare.com/ajax/libs/highlight.js/8.4/highlight.min.js"></script>
        <script type="text/javascript">
            $(document).ready(function() {
                $.ajax('js/example-IGN.js', {dataType: 'script'})
