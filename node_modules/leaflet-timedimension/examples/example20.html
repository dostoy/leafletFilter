<html>
    ...
    <body>
        <div class="container">
            <div id="header">
                <h1>Leaflet TimeDimension example 20</h1>                
                <h2>GeoJSON features with time</h2>
            </div>
        ...
        <script type="text/javascript" src="js/example20.js"></script>
        <script src="http://cdnjs.cloudflare.com/ajax/libs/highlight.js/8.4/highlight.min.js"></script>
        <script type="text/javascript">
            $(document).ready(function() {
                $.ajax('js/example20.js', {dataType: 'script'})
