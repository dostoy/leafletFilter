...
L.Control.Velocity = L.Control.extend({
	...
	_onMouseMove: function _onMouseMove(e) {
		...
		var controlV = document.getElementsByClassName('leaflet-control-velocity')[0];
		if (indexInParent(controlV) == 0){
			var controlP = document.getElementsByClassName('leaflet-control-mouseposition')[0];
			if (controlP){
				controlP.parentNode.insertBefore(controlV, controlP.nextSibling);				
			}
		}
	}
  ...
  */
   ...
   */
	...
	var animate = function animate(bounds, field) {
		...
		// hack: same amount of particles. Independent of the map size
		particleCount = Math.round(1500 * 800 * PARTICLE_MULTIPLIER);
		if (isMobile()) {
