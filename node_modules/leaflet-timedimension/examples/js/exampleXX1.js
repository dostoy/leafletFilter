...
// var imageUrl = 'http://socib.es/users/dataprocuser/media/operational_models/oceanographical/hydrodynamics/wmopv2/latest/sea_water_potential_temperature/sea_water_potential_temperature_wmopv2_mobile_20170901_0000.png',
//    imageBounds = [[37.5, -1.0], [41.5, 6.0]];
var imageUrl = 'http://socib.es/users/dataprocuser/media/operational_models/oceanographical/wave/sapo_ib/latest/sea_surface_wave_significant_height/sea_surface_wave_significant_height_sapo_ib_mobile_20170901_0000.png',
    imageBounds = [[38.55, 0.5], [40.17, 4.4]];
...
var getImageUrl = function(baseUrl, time) {
    var beginUrl = baseUrl.substring(0, baseUrl.lastIndexOf("_mobile_") + 8);
    var strTime = new Date(time).format('yyyymmdd_HHMM', true);    
    url = beginUrl + strTime + '.png';
    return url;
};
