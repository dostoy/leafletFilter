<html>
    ...
    <body>
        <div class="container">
            <div id="header">
                <h1>Leaflet TimeDimension example 18</h1>                
                <h2>Filter GeoJSON features with timecoverage</h2>
            </div>
            ...
            <div class="prev-example">
                <a href="example17.html">Example 17:</a>
            </div>                 
        ...
        <script type="text/javascript" src="js/example18.js"></script>
        <script src="http://cdnjs.cloudflare.com/ajax/libs/highlight.js/8.4/highlight.min.js"></script>
        <script type="text/javascript">
            $(document).ready(function() {
                $.ajax('js/example18.js', {dataType: 'script'})
