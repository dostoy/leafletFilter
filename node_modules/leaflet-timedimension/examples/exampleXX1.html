<html>
    ...
    <body>
        <div class="container">
            <div id="header">
                <h1>Leaflet TimeDimension example XX1</h1>                
                <h2>SOCIB generated figures</h2>
            </div>
            ...
            <div class="prev-example">
                <a href="example17.html">Example 19:</a>
            </div>                 
        ...
        <script type="text/javascript" src="js/exampleXX1.js"></script>
        <script src="http://cdnjs.cloudflare.com/ajax/libs/highlight.js/8.4/highlight.min.js"></script>
        <script type="text/javascript">
            $(document).ready(function() {
                $.ajax('js/exampleXX1.js', {dataType: 'script'})
